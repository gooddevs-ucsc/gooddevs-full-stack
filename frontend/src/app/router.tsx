  ...
  createBrowserRouter([
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: paths.requester.donationsSponsorships.path,
          lazy: () =>
            import('./routes/requester/donations-sponsorships').then(
              convert(queryClient),
            ),
        },
        {
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: paths.developer.donationsSponsorships.path,
          lazy: () =>
            import('./routes/developer/donations-sponsorships').then(
              convert(queryClient),
            ),
        },
        {
