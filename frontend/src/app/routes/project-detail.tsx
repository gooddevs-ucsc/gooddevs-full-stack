...
import { LoaderFunctionArgs, useParams, useNavigate } from 'react-router';
...
export const clientLoader =
  ...
  async ({ params }: LoaderFunctionArgs) => {
    ...
    const query = getProjectByIdQueryOptions(projectId);
...
const ProjectDetailRoute = () => {
  ...
  const projectQuery = useProjectById({ id: id! });
              ...
              <div className="mt-8 rounded-xl border border-slate-200/60 bg-white p-8 shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    <div className="mr-3 mt-1 size-2 rounded-full bg-primary"></div>
                    <p className="text-slate-700">
                      Gain experience with modern technologies and best
                      practices
                    </p>
                  </div>
                  <div className="flex items-start">
                    <div className="mr-3 mt-1 size-2 rounded-full bg-primary"></div>
                    <p className="text-slate-700">
                      Contribute to open-source projects and build your
                      portfolio
                    </p>
                  </div>
                </div>
