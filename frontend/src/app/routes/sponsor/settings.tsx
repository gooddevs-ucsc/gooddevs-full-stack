            ...
            {({ register, formState }) => (
              <>
                ...
                <button
                  ...
                  className="w-full rounded-md bg-green-600 px-3 py-2 text-sm text-white transition hover:bg-green-700 disabled:cursor-not-allowed disabled:bg-green-300 disabled:text-green-100"
                >
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-lg">
          ...
          <div className="space-y-4">
            <button
              ...
              className={`rounded-lg px-6 py-3 font-medium transition ${notificationsEnabled ? 'bg-green-600 text-white hover:bg-green-700' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
            >
