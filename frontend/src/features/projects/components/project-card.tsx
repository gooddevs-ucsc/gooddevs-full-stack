...
const getProjectTypeColor = (type: ProjectType): string => {
  const colors = {
    [ProjectType.WEBSITE]: 'bg-blue-50 text-blue-800 border border-blue-200',
    [ProjectType.MOBILE_APP]:
      'bg-emerald-50 text-emerald-800 border border-emerald-200',
    [ProjectType.DATABASE]:
      'bg-purple-50 text-purple-800 border border-purple-200',
    [ProjectType.API]: 'bg-amber-50 text-amber-800 border border-amber-200',
    [ProjectType.DESKTOP_APP]:
      'bg-rose-50 text-rose-800 border border-rose-200',
    [ProjectType.OTHER]: 'bg-slate-50 text-slate-700 border border-slate-200',
  };
  return colors[type] || colors[ProjectType.OTHER];
};
