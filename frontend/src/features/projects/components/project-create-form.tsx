...
import { GenerateProjectDetailsModal } from './generate-project-details-modal';
...
export const ProjectCreateForm = () => {
  ...
  return (
    <div className="rounded-xl border border-slate-200/60 bg-white shadow-sm">
      ...
      <div className="p-6">
        <Form onSubmit={onSubmit} schema={createProjectInputSchema}>
          {({ register, formState, setValue }) => {
            const handleGenerateDetailsWithSetValue = (
              ...
              try {
                ...
                setValue('project_type', details.project_type, {
                  shouldValidate: true,
                  shouldDirty: true,
                  shouldTouch: true,
                });

                setValue('estimated_timeline', details.estimated_timeline, {
                  shouldValidate: true,
                  shouldDirty: true,
                  shouldTouch: true,
                });
                ...
                addNotification({
                  ...
                  message:
                    'Project details have been generated! Feel free to edit them before submitting.',
                });
              } catch (error) {
                addNotification({
                  type: 'error',
                  title: 'Error',
                  message: 'Failed to populate form fields. Please try again.',
                });
              }
            };
            ...
            return (
              <>
                ...
                {/* AI Generation Modal */}
                <GenerateProjectDetailsModal
                  open={aiModal.isOpen}
                  onOpenChange={handleOpenChange}
                  onGenerate={handleGenerateDetailsWithSetValue}
                />
              </>
            );
          }}
