          ...
          <TabsContent value="tasks" className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      {project.estimated_timeline ? formatEstimatedTimeline(project.estimated_timeline) : 'TBD'}
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
            ...
            <div className="rounded-xl border border-slate-200/60 bg-white p-8 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                {project.preferred_technologies && (
                  <div className="mt-6">
                    <h3 className="mb-2 font-medium text-slate-900">Tech Stack</h3>
                    <p className="text-slate-700">{project.preferred_technologies}</p>
                  </div>
                )}
              </div>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-blue-500 pl-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-3">
                      <div className="size-2 rounded-full bg-blue-500"></div>
                      <span className="text-slate-700">Project architecture planning</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="size-2 rounded-full bg-blue-500"></div>
                      <span className="text-slate-700">Development environment setup</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="size-2 rounded-full bg-blue-500"></div>
                      <span className="text-slate-700">Team communication channels</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-l-4 border-green-500 pl-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-3">
                      <div className="size-2 rounded-full bg-green-500"></div>
                      <span className="text-slate-700">Backend API development</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="size-2 rounded-full bg-green-500"></div>
                      <span className="text-slate-700">Frontend user interface</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="size-2 rounded-full bg-green-500"></div>
                      <span className="text-slate-700">Database design & implementation</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-l-4 border-purple-500 pl-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-3">
                      <div className="size-2 rounded-full bg-purple-500"></div>
                      <span className="text-slate-700">Unit and integration testing</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="size-2 rounded-full bg-purple-500"></div>
                      <span className="text-slate-700">User acceptance testing</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="size-2 rounded-full bg-purple-500"></div>
                      <span className="text-slate-700">Production deployment</span>
                    </div>
                  </div>
                </div>
              </div>
